/*
File: catkin_ws/src/romi_base/src/a_star.cpp
...
/***************************************************** 
    Name: setYellowLED
    Description: Writes the yellow LED state (0-255) to register 0
******************************************************/
...
/***************************************************** 
    Name: setGreenLED
    Description: Writes the green LED state (0-255) to register 1
******************************************************/
...
/***************************************************** 
    Name: setRedLED
    Description: Writes the red LED state (0-255) to register 2
******************************************************/
...
/***************************************************** 
    Name: playNotes
    Description: Writes the notes to play on the buzzer to registers 25-38
******************************************************/
...
/***************************************************** 
    Name: setMotors
    Description: Writes the motor speeds to registers 6-9
******************************************************/
...
/***************************************************** 
    Name: setNewTarget
    Description: Writes a boolean flag to register 43 to indicate a new command has been sent
******************************************************/
...
/***************************************************** 
    Name: readButtons
    Description: Reads the three button states from registers 3-5
******************************************************/
...
/***************************************************** 
    Name: readBatteryMillivolts
    Description: Reads the battery status in millivolts from registers 10-11
******************************************************/
...
/***************************************************** 
    Name: readAnalog
    Description: Reads the 6 ADC values from register 12-23
******************************************************/
...
/***************************************************** 
    Name: readEncoders
    Description: Reads the encoder values from registers 39-42
******************************************************/
...
/***************************************************** 
    Name: testRead8
    Description: Writes a byte of zeros to register 0
******************************************************/
...
/***************************************************** 
    Name: testWrite8
    Description: Reads a byte from register 0
******************************************************/
